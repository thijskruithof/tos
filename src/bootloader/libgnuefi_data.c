...
EFI_UNICODE_COLLATION_INTERFACE   LibStubUnicodeInterface = {
    NULL, // Original value of 'LibStubStriCmp' commented out as recommended in https://wiki.osdev.org/UEFI_App_Bare_Bones#hello.c,
    NULL, // Original value of 'LibStubMetaiMatch' commented out as recommended in https://wiki.osdev.org/UEFI_App_Bare_Bones#hello.c
    NULL, // Original value of 'LibStubStrLwrUpr' commented out as recommended in https://wiki.osdev.org/UEFI_App_Bare_Bones#hello.c
    NULL, // Original value of 'LibStubStrLwrUpr' commented out as recommended in https://wiki.osdev.org/UEFI_App_Bare_Bones#hello.c
    NULL,   // FatToStr
    NULL,   // StrToFat
